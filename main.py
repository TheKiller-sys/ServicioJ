...
def set_webhook():
    ...
    webhook_url = 'https://{}/{}'.format(request.host, TELEGRAM_TOKEN) # Replace with your actual URL
    s = bot.set_webhook(webhook_url=webhook_url)
    if s:
...
if __name__ == '__main__':
    ...
    # set_webhook() # Set the webhook on startup (optional, can be done manually)
